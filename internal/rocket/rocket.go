//go:generate mockgen -destination=rocket_mocks_test.go -package=rocket github.com/rsh456/grpc-services/internal/rocket Store
...
// Service - our rocket server, responsible for
//updating the rocket
type Service struct {
	Store Store
}

// New - returns a new instance for our rocket service
...
// ctx allow us for instance cancel an incoming request
